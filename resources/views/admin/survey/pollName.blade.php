...
@section('content')
    ...
    <form action="{{ route('pollNameSubmit') }}" method="post" enctype="multipart/form-data">
        {{ @csrf_field() }}
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Poll Name</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="/">Manage Poll</a></li>
            ...
            <section class="content">
                ...
                <fieldset>
                    <div class="row justify-content-center vote_header">
                        ...
                        <h4><a class="btn btn-primary poll_Link" href="#">See All Poll</a></h4>
